...
void CaptivePortal::handle_index(AsyncWebServerRequest *request) {
  ...
  if (request->hasArg("save")) {
    stream->print(F("<div class=\"info\">The KAUF Smart Bulb will now try to connect to the network...<br/><br/>"
                    "Please give it some time to connect.</div>"));
  }
  ...
  stream->print(F("<h1>OTA Update: </h1>"
                  ...
                  "**** DO NOT USE ANY <b>WLED</b> BIN file.  WLED is not going to work properly on this bulb.  Use the included DDP functionality to control this bulb from another WLED instance or xLights.<br /><br />"
                  "After the firmware is uploaded, a blank page will appear with the message <b>Update Successful!</b>.  If anything strange or different happens, please remove power to the bulb before trying to flash again. <br /><br /> "
